...
function Stripes() {
    ...
    const data = [
        ...
        {url: "https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63d6e83420934a94d642103b_NCC2021_LogoLockup%201.svg", num: "52"},
        {url: "https://assets-global.website-files.com/6334198f239547d0f9cd84b3/63c9ce90a51cd7cf6b3689fb_css-design-awards-logos-id1L9L8Yvp%201.svg", num: "11"}
    ]
  return (
    <div className='flex justify-between h-16 border-t-1 border-b-1 border-zinc-500 mt-22'>
        {data.map((elem, index) => (
